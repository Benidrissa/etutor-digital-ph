...
def downgrade() -> None:
    ...
    op.drop_index("idx_enrollment_status", table_name="user_course_enrollments")
    op.drop_index("idx_enrollment_course_id", table_name="user_course_enrollments")
    op.drop_index("idx_enrollment_user_id", table_name="user_course_enrollments")
    op.drop_table("user_course_enrollments")
    op.drop_index("idx_courses_domain", table_name="courses")
