...
class JWTAuthService:
    ...
    def __init__(self):
        ...
        self.access_token_expire_minutes = _cache.get("auth-access-token-expiry-minutes", 15)
        self.refresh_token_expire_days = _cache.get("auth-refresh-token-expiry-days", 90)
    ...
    def create_password_reset_token(self, user_id: str, email: str) -> str:
        ...
        expire = now + timedelta(
            hours=SettingsCache.instance().get("auth-magic-link-expiry-hours", 1)
        )
