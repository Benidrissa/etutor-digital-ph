...
class TutorService:
    ...
    def __init__(
        ...
        self.memory_service = learner_memory_service or LearnerMemoryService()
    ...
    async def send_message(
        ...
        try:
            ...
            try:
                memory_prompt = await self.memory_service.format_for_prompt(user_id, session)
            except Exception:
                memory_prompt = ""
