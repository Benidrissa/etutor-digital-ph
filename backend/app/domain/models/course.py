...
class Course(Base):
    ...
    visibility: Mapped[str] = mapped_column(String(16), server_default="public", nullable=False)
    price_credits: Mapped[int] = mapped_column(Integer, server_default="0", nullable=False)
