...
async def get_dashboard_stats(
    ...
    - **is_active_today**: True if user has been active today (≥1 quiz OR ≥5 flashcard reviews OR ≥1 lesson read)
    ...
    Send timezone offset in `X-Timezone-Offset` header (e.g., "+01:00", "-05:00") for accurate streak calculations.
    """
    try:
