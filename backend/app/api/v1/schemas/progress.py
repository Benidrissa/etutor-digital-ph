...
class ModuleProgressResponse(BaseModel):
    ...
    title_fr: str = Field(default="", description="Module title in French")
    title_en: str = Field(default="", description="Module title in English")
    description_fr: str | None = Field(default=None, description="Module description in French")
    description_en: str | None = Field(default=None, description="Module description in English")
    level: int = Field(default=1, description="Curriculum level (1-4)")
    estimated_hours: int = Field(default=0, description="Estimated hours to complete")
