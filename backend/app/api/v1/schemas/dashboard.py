...
class DashboardStatsResponse(BaseModel):
    ...
    average_quiz_score: float = Field(description="Average quiz score percentage across all modules")
    ...
    completion_percentage: float = Field(description="Overall completion percentage across all modules")
