...
SETTING_DEFINITIONS: list[SettingDef] = [
    ...
    SettingDef(
        ...
        "Chars per chunk during PDF summarization. 0 = compute from model.",
    ...
    SettingDef(
        ...
        "Deprecated. Use syllabus-combine-chunk-size-chars instead.",
        {"min": 10_000, "max": 1_000_000},
    ),
    SettingDef(
        ...
        200_000,
        "integer",
        "Combine chunk size (chars)",
        "Max chars when combining chunk summaries. 0 = compute from model.",
        {"min": 10_000, "max": 1_000_000},
    ),
    SettingDef(
    ...
    SettingDef(
        ...
        "Deprecated. Use syllabus-chunk-max-output-tokens instead.",
        {"min": 1024, "max": 64_000},
    ),
    SettingDef(
        ...
        "Max output tokens for each chunk summary response. 0 = compute from model.",
        {"min": 1024, "max": 64_000},
    ),
    SettingDef(
        ...
        "Deprecated. Use syllabus-combine-max-output-tokens instead.",
        {"min": 2048, "max": 64_000},
    ),
    SettingDef(
