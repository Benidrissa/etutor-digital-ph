...
SETTING_DEFINITIONS: list[SettingDef] = [
    ...
    SettingDef(
        ...
        (
            ...
            "Section 2 — real_data (tables, structured lists, or other appropriate evidence formats):\n"
            "   - Quantitative data where available: key figures, measurable indicators\n"
            "   - Temporal or process data: event timeline, decision sequence, or workflow\n"
            "   - Contextual data: geographic, organizational, or stakeholder distribution\n"
            "   - Sources: professional organizations, institutional reports, sector data, or authoritative references\n\n"
