...
SETTING_DEFINITIONS: list[SettingDef] = [
    ...
    SettingDef(
        ...
        "Chars per chunk during PDF summarization.",
    ...
    SettingDef(
        ...
        "Max chars when combining chunk summaries.",
        {"min": 10_000, "max": 200_000},
    ),
    SettingDef(
    ...
    SettingDef(
        ...
        "Max tokens for each chunk summary response.",
        {"min": 1024, "max": 16384},
    ),
    SettingDef(
        ...
        8192,
        "integer",
        "Combined summary max tokens",
        "Max tokens for combined summary response.",
        {"min": 2048, "max": 32768},
    ),
    SettingDef(
